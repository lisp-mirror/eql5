...
class N166 : public N156 { // QQuickImageProvider
    Q_OBJECT
public:
...
class N165 : public N166 { // QQuickAsyncImageProvider
    Q_OBJECT
public:
    Q_INVOKABLE void* C(uint u) { return new LQuickAsyncImageProvider(u); }
    Q_INVOKABLE QQuickImageResponse* MrequestImageResponse(QQuickAsyncImageProvider* o, const QString& x1, const QSize& x2) { return o->requestImageResponse(x1, x2); }
};
