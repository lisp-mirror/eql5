...
public:
    ...
    QObject* beginCreate(QQmlContext* x1) { quint64 id = LObjects::override_id(unique, 322); void* fun = LObjects::overrideFun(id); QObject* ret = 0; if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; ret = (QObject*)callOverrideFun(fun, 322, args, id).value<void*>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQmlComponent::beginCreate(x1); } return ret; }
    void completeCreate() { quint64 id = LObjects::override_id(unique, 323); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { callOverrideFun(fun, 323, 0, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQmlComponent::completeCreate(); }}
    QObject* create(QQmlContext* x1 = 0) { quint64 id = LObjects::override_id(unique, 324); void* fun = LObjects::overrideFun(id); QObject* ret = 0; if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; ret = (QObject*)callOverrideFun(fun, 324, args, id).value<void*>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQmlComponent::create(x1); } return ret; }
...
public:
    ...
    void initializeEngine(QQmlEngine* x1, const char* x2) { quint64 id = LObjects::override_id(unique, 325); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1, &x2 }; callOverrideFun(fun, 325, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQmlExtensionPlugin::initializeEngine(x1, x2); }}
    void registerTypes(const char* x1) { quint64 id = LObjects::override_id(unique, 326); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 326, args, id); }}
...
public:
    ...
    QVariant updateValue(const QString& x1, const QVariant& x2) { quint64 id = LObjects::override_id(unique, 327); void* fun = LObjects::overrideFun(id); QVariant ret; if(fun && (LObjects::calling != id)) { const void* args[] = { &x1, &x2 }; ret = callOverrideFun(fun, 327, args, id).value<QVariant>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQmlPropertyMap::updateValue(x1, x2); } return ret; }
...
class LQuickImageResponse : public QQuickImageResponse {
    Q_OBJECT
    friend class Q177;
public:
    LQuickImageResponse(uint u) : unique(u) {}

    static NumList overrideIds;
    uint unique;

    QString errorString() const { quint64 id = LObjects::override_id(unique, 328); void* fun = LObjects::overrideFun(id); QString ret; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 328, 0, id).value<QString>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQuickImageResponse::errorString(); } return ret; }
    QQuickTextureFactory* textureFactory() const { quint64 id = LObjects::override_id(unique, 329); void* fun = LObjects::overrideFun(id); QQuickTextureFactory* ret = 0; if(fun && (LObjects::calling != id)) { ret = (QQuickTextureFactory*)callOverrideFun(fun, 329, 0, id).value<void*>(); } return ret; }
    ...
    void childEvent(QChildEvent* x1) { quint64 id = LObjects::override_id(unique, 6); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 6, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickImageResponse::childEvent(x1); }}
    void customEvent(QEvent* x1) { quint64 id = LObjects::override_id(unique, 7); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 7, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickImageResponse::customEvent(x1); }}
    void timerEvent(QTimerEvent* x1) { quint64 id = LObjects::override_id(unique, 8); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 8, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickImageResponse::timerEvent(x1); }}
};
...
public:
    ...
    bool isTextureProvider() const { quint64 id = LObjects::override_id(unique, 330); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 330, 0, id).toBool(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQuickItem::isTextureProvider(); } return ret; }
    QSGTextureProvider* textureProvider() const { quint64 id = LObjects::override_id(unique, 331); void* fun = LObjects::overrideFun(id); QSGTextureProvider* ret = 0; if(fun && (LObjects::calling != id)) { ret = (QSGTextureProvider*)callOverrideFun(fun, 331, 0, id).value<void*>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQuickItem::textureProvider(); } return ret; }
    bool childMouseEventFilter(QQuickItem* x1, QEvent* x2) { quint64 id = LObjects::override_id(unique, 332); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { const void* args[] = { &x1, &x2 }; ret = callOverrideFun(fun, 332, args, id).toBool(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQuickItem::childMouseEventFilter(x1, x2); } return ret; }
    ...
    void geometryChanged(const QRectF& x1, const QRectF& x2) { quint64 id = LObjects::override_id(unique, 333); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1, &x2 }; callOverrideFun(fun, 333, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickItem::geometryChanged(x1, x2); }}
    void hoverEnterEvent(QHoverEvent* x1) { quint64 id = LObjects::override_id(unique, 334); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 334, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickItem::hoverEnterEvent(x1); }}
    void hoverLeaveEvent(QHoverEvent* x1) { quint64 id = LObjects::override_id(unique, 335); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 335, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickItem::hoverLeaveEvent(x1); }}
    void hoverMoveEvent(QHoverEvent* x1) { quint64 id = LObjects::override_id(unique, 336); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 336, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickItem::hoverMoveEvent(x1); }}
    ...
    void itemChange(ItemChange x1, const ItemChangeData& x2) { quint64 id = LObjects::override_id(unique, 337); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1, &x2 }; callOverrideFun(fun, 337, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickItem::itemChange(x1, x2); }}
    ...
    void mouseUngrabEvent() { quint64 id = LObjects::override_id(unique, 338); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { callOverrideFun(fun, 338, 0, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickItem::mouseUngrabEvent(); }}
    void releaseResources() { quint64 id = LObjects::override_id(unique, 339); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { callOverrideFun(fun, 339, 0, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickItem::releaseResources(); }}
    void touchEvent(QTouchEvent* x1) { quint64 id = LObjects::override_id(unique, 310); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 310, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickItem::touchEvent(x1); }}
    void touchUngrabEvent() { quint64 id = LObjects::override_id(unique, 340); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { callOverrideFun(fun, 340, 0, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickItem::touchUngrabEvent(); }}
    QSGNode* updatePaintNode(QSGNode* x1, UpdatePaintNodeData* x2) { quint64 id = LObjects::override_id(unique, 341); void* fun = LObjects::overrideFun(id); QSGNode* ret = 0; if(fun && (LObjects::calling != id)) { const void* args[] = { &x1, &x2 }; ret = (QSGNode*)callOverrideFun(fun, 341, args, id).value<void*>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQuickItem::updatePaintNode(x1, x2); } return ret; }
    void updatePolish() { quint64 id = LObjects::override_id(unique, 342); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { callOverrideFun(fun, 342, 0, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickItem::updatePolish(); }}
...
public:
    ...
    void paint(QPainter* x1) { quint64 id = LObjects::override_id(unique, 343); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 343, args, id); }}
    bool isTextureProvider() const { quint64 id = LObjects::override_id(unique, 330); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 330, 0, id).toBool(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQuickPaintedItem::isTextureProvider(); } return ret; }
    QSGTextureProvider* textureProvider() const { quint64 id = LObjects::override_id(unique, 331); void* fun = LObjects::overrideFun(id); QSGTextureProvider* ret = 0; if(fun && (LObjects::calling != id)) { ret = (QSGTextureProvider*)callOverrideFun(fun, 331, 0, id).value<void*>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQuickPaintedItem::textureProvider(); } return ret; }
    void releaseResources() { quint64 id = LObjects::override_id(unique, 339); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { callOverrideFun(fun, 339, 0, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickPaintedItem::releaseResources(); }}
    QSGNode* updatePaintNode(QSGNode* x1, UpdatePaintNodeData* x2) { quint64 id = LObjects::override_id(unique, 341); void* fun = LObjects::overrideFun(id); QSGNode* ret = 0; if(fun && (LObjects::calling != id)) { const void* args[] = { &x1, &x2 }; ret = (QSGNode*)callOverrideFun(fun, 341, args, id).value<void*>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQuickPaintedItem::updatePaintNode(x1, x2); } return ret; }
    bool contains(const QPointF& x1) const { quint64 id = LObjects::override_id(unique, 267); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; ret = callOverrideFun(fun, 267, args, id).toBool(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQuickPaintedItem::contains(x1); } return ret; }
    ...
    bool childMouseEventFilter(QQuickItem* x1, QEvent* x2) { quint64 id = LObjects::override_id(unique, 332); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { const void* args[] = { &x1, &x2 }; ret = callOverrideFun(fun, 332, args, id).toBool(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQuickPaintedItem::childMouseEventFilter(x1, x2); } return ret; }
    ...
    void geometryChanged(const QRectF& x1, const QRectF& x2) { quint64 id = LObjects::override_id(unique, 333); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1, &x2 }; callOverrideFun(fun, 333, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickPaintedItem::geometryChanged(x1, x2); }}
    void hoverEnterEvent(QHoverEvent* x1) { quint64 id = LObjects::override_id(unique, 334); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 334, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickPaintedItem::hoverEnterEvent(x1); }}
    void hoverLeaveEvent(QHoverEvent* x1) { quint64 id = LObjects::override_id(unique, 335); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 335, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickPaintedItem::hoverLeaveEvent(x1); }}
    void hoverMoveEvent(QHoverEvent* x1) { quint64 id = LObjects::override_id(unique, 336); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 336, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickPaintedItem::hoverMoveEvent(x1); }}
    ...
    void itemChange(ItemChange x1, const ItemChangeData& x2) { quint64 id = LObjects::override_id(unique, 337); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1, &x2 }; callOverrideFun(fun, 337, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickPaintedItem::itemChange(x1, x2); }}
    ...
    void mouseUngrabEvent() { quint64 id = LObjects::override_id(unique, 338); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { callOverrideFun(fun, 338, 0, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickPaintedItem::mouseUngrabEvent(); }}
    void touchEvent(QTouchEvent* x1) { quint64 id = LObjects::override_id(unique, 310); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 310, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickPaintedItem::touchEvent(x1); }}
    void touchUngrabEvent() { quint64 id = LObjects::override_id(unique, 340); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { callOverrideFun(fun, 340, 0, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickPaintedItem::touchUngrabEvent(); }}
    void updatePolish() { quint64 id = LObjects::override_id(unique, 342); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { callOverrideFun(fun, 342, 0, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickPaintedItem::updatePolish(); }}
...
public:
    ...
    QSGTexture* createTexture(QQuickWindow* x1) const { quint64 id = LObjects::override_id(unique, 344); void* fun = LObjects::overrideFun(id); QSGTexture* ret = 0; if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; ret = (QSGTexture*)callOverrideFun(fun, 344, args, id).value<void*>(); } return ret; }
    QImage image() const { quint64 id = LObjects::override_id(unique, 345); void* fun = LObjects::overrideFun(id); QImage ret; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 345, 0, id).value<QImage>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQuickTextureFactory::image(); } return ret; }
    int textureByteCount() const { quint64 id = LObjects::override_id(unique, 346); void* fun = LObjects::overrideFun(id); int ret = 0; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 346, 0, id).toInt(); } return ret; }
    QSize textureSize() const { quint64 id = LObjects::override_id(unique, 347); void* fun = LObjects::overrideFun(id); QSize ret; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 347, 0, id).value<QSize>(); } return ret; }
...
public:
    ...
    QObject* focusObject() const { quint64 id = LObjects::override_id(unique, 308); void* fun = LObjects::overrideFun(id); QObject* ret = 0; if(fun && (LObjects::calling != id)) { ret = (QObject*)callOverrideFun(fun, 308, 0, id).value<void*>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQuickView::focusObject(); } return ret; }
    void exposeEvent(QExposeEvent* x1) { quint64 id = LObjects::override_id(unique, 309); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 309, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickView::exposeEvent(x1); }}
    ...
    void touchEvent(QTouchEvent* x1) { quint64 id = LObjects::override_id(unique, 310); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 310, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickView::touchEvent(x1); }}
    ...
    QSurfaceFormat format() const { quint64 id = LObjects::override_id(unique, 311); void* fun = LObjects::overrideFun(id); QSurfaceFormat ret; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 311, 0, id).value<QSurfaceFormat>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQuickView::format(); } return ret; }
    QSize size() const { quint64 id = LObjects::override_id(unique, 141); void* fun = LObjects::overrideFun(id); QSize ret; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 141, 0, id).value<QSize>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQuickView::size(); } return ret; }
    SurfaceType surfaceType() const { quint64 id = LObjects::override_id(unique, 312); void* fun = LObjects::overrideFun(id); SurfaceType ret = (SurfaceType)0; if(fun && (LObjects::calling != id)) { ret = (SurfaceType)callOverrideFun(fun, 312, 0, id).toInt(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQuickView::surfaceType(); } return ret; }
...
public:
    ...
    QObject* focusObject() const { quint64 id = LObjects::override_id(unique, 308); void* fun = LObjects::overrideFun(id); QObject* ret = 0; if(fun && (LObjects::calling != id)) { ret = (QObject*)callOverrideFun(fun, 308, 0, id).value<void*>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQuickWindow::focusObject(); } return ret; }
    void exposeEvent(QExposeEvent* x1) { quint64 id = LObjects::override_id(unique, 309); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 309, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickWindow::exposeEvent(x1); }}
    ...
    void touchEvent(QTouchEvent* x1) { quint64 id = LObjects::override_id(unique, 310); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 310, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QQuickWindow::touchEvent(x1); }}
    ...
    QSurfaceFormat format() const { quint64 id = LObjects::override_id(unique, 311); void* fun = LObjects::overrideFun(id); QSurfaceFormat ret; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 311, 0, id).value<QSurfaceFormat>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQuickWindow::format(); } return ret; }
    QSize size() const { quint64 id = LObjects::override_id(unique, 141); void* fun = LObjects::overrideFun(id); QSize ret; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 141, 0, id).value<QSize>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQuickWindow::size(); } return ret; }
...
public:
    ...
    void renderScene(GLuint x1 = 0) { quint64 id = LObjects::override_id(unique, 348); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 348, args, id); }}
...
public:
    ...
    bool updateTexture() { quint64 id = LObjects::override_id(unique, 349); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 349, 0, id).toBool(); } return ret; }
    void bind() { quint64 id = LObjects::override_id(unique, 350); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { callOverrideFun(fun, 350, 0, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QSGDynamicTexture::bind(); }}
    bool hasAlphaChannel() const { quint64 id = LObjects::override_id(unique, 351); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 351, 0, id).toBool(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QSGDynamicTexture::hasAlphaChannel(); } return ret; }
    bool hasMipmaps() const { quint64 id = LObjects::override_id(unique, 352); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 352, 0, id).toBool(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QSGDynamicTexture::hasMipmaps(); } return ret; }
    bool isAtlasTexture() const { quint64 id = LObjects::override_id(unique, 353); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 353, 0, id).toBool(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QSGDynamicTexture::isAtlasTexture(); } return ret; }
    QRectF normalizedTextureSubRect() const { quint64 id = LObjects::override_id(unique, 354); void* fun = LObjects::overrideFun(id); QRectF ret; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 354, 0, id).value<QRectF>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QSGDynamicTexture::normalizedTextureSubRect(); } return ret; }
    ...
    int textureId() const { quint64 id = LObjects::override_id(unique, 356); void* fun = LObjects::overrideFun(id); int ret = 0; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 356, 0, id).toInt(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QSGDynamicTexture::textureId(); } return ret; }
    QSize textureSize() const { quint64 id = LObjects::override_id(unique, 347); void* fun = LObjects::overrideFun(id); QSize ret; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 347, 0, id).value<QSize>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QSGDynamicTexture::textureSize(); } return ret; }
...
public:
    ...
    void bind() { quint64 id = LObjects::override_id(unique, 350); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { callOverrideFun(fun, 350, 0, id); }}
    bool hasAlphaChannel() const { quint64 id = LObjects::override_id(unique, 351); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 351, 0, id).toBool(); } return ret; }
    bool hasMipmaps() const { quint64 id = LObjects::override_id(unique, 352); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 352, 0, id).toBool(); } return ret; }
    bool isAtlasTexture() const { quint64 id = LObjects::override_id(unique, 353); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 353, 0, id).toBool(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QSGTexture::isAtlasTexture(); } return ret; }
    QRectF normalizedTextureSubRect() const { quint64 id = LObjects::override_id(unique, 354); void* fun = LObjects::overrideFun(id); QRectF ret; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 354, 0, id).value<QRectF>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QSGTexture::normalizedTextureSubRect(); } return ret; }
    QSGTexture* removedFromAtlas() const { quint64 id = LObjects::override_id(unique, 355); void* fun = LObjects::overrideFun(id); QSGTexture* ret = 0; if(fun && (LObjects::calling != id)) { ret = (QSGTexture*)callOverrideFun(fun, 355, 0, id).value<void*>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QSGTexture::removedFromAtlas(); } return ret; }
    int textureId() const { quint64 id = LObjects::override_id(unique, 356); void* fun = LObjects::overrideFun(id); int ret = 0; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 356, 0, id).toInt(); } return ret; }
    QSize textureSize() const { quint64 id = LObjects::override_id(unique, 347); void* fun = LObjects::overrideFun(id); QSize ret; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 347, 0, id).value<QSize>(); } return ret; }
...
public:
    ...
    QSGTexture* texture() const { quint64 id = LObjects::override_id(unique, 357); void* fun = LObjects::overrideFun(id); QSGTexture* ret = 0; if(fun && (LObjects::calling != id)) { ret = (QSGTexture*)callOverrideFun(fun, 357, 0, id).value<void*>(); } return ret; }
