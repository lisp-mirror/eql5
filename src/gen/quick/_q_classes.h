...
public:
    ...
    void registerTypes(const char* x1) { quint64 id = LObjects::override_id(unique, 325); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 325, args, id); }}
...
public:
    ...
    QVariant updateValue(const QString& x1, const QVariant& x2) { quint64 id = LObjects::override_id(unique, 326); void* fun = LObjects::overrideFun(id); QVariant ret; if(fun && (LObjects::calling != id)) { const void* args[] = { &x1, &x2 }; ret = callOverrideFun(fun, 326, args, id).value<QVariant>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQmlPropertyMap::updateValue(x1, x2); } return ret; }
...
public:
    ...
    QString errorString() const { quint64 id = LObjects::override_id(unique, 327); void* fun = LObjects::overrideFun(id); QString ret; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 327, 0, id).value<QString>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QQuickImageResponse::errorString(); } return ret; }
    QQuickTextureFactory* textureFactory() const { quint64 id = LObjects::override_id(unique, 328); void* fun = LObjects::overrideFun(id); QQuickTextureFactory* ret = 0; if(fun && (LObjects::calling != id)) { ret = (QQuickTextureFactory*)callOverrideFun(fun, 328, 0, id).value<void*>(); } return ret; }
