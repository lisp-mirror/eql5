...
class N201 : public QObject { // QWebDatabase
    Q_OBJECT
public:
...
class N202 : public QObject { // QWebElement
    Q_OBJECT
public:
...
class N203 : public QObject { // QWebElementCollection
    Q_OBJECT
public:
...
class N204 : public QObject { // QWebHistory
    Q_OBJECT
public:
...
class N205 : public QObject { // QWebHistoryItem
    Q_OBJECT
public:
...
class N206 : public QObject { // QWebHitTestResult
    Q_OBJECT
public:
...
class N207 : public QObject { // QWebSecurityOrigin
    Q_OBJECT
public:
...
class N208 : public QObject { // QWebSettings
    Q_OBJECT
public:
