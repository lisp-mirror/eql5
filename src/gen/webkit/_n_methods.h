...
class N232 : public QObject { // QWebDatabase
    Q_OBJECT
public:
...
class N233 : public QObject { // QWebElement
    Q_OBJECT
public:
...
class N235 : public QObject { // QWebHistory
    Q_OBJECT
public:
...
class N236 : public QObject { // QWebHistoryItem
    Q_OBJECT
public:
...
class N237 : public QObject { // QWebHitTestResult
    Q_OBJECT
public:
...
class N238 : public QObject { // QWebSecurityOrigin
    Q_OBJECT
public:
...
class N239 : public QObject { // QWebSettings
    Q_OBJECT
public:
