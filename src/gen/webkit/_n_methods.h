...
class N203 : public QObject { // QWebDatabase
    Q_OBJECT
public:
...
class N205 : public QObject { // QWebElementCollection
    Q_OBJECT
public:
...
class N206 : public QObject { // QWebHistory
    Q_OBJECT
public:
...
class N207 : public QObject { // QWebHistoryItem
    Q_OBJECT
public:
...
class N209 : public QObject { // QWebSecurityOrigin
    Q_OBJECT
public:
...
class N210 : public QObject { // QWebSettings
    Q_OBJECT
public:
