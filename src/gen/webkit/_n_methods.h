...
class N206 : public QObject { // QWebDatabase
    Q_OBJECT
public:
...
class N209 : public QObject { // QWebHistory
    Q_OBJECT
public:
...
class N210 : public QObject { // QWebHistoryItem
    Q_OBJECT
public:
...
class N212 : public QObject { // QWebSecurityOrigin
    Q_OBJECT
public:
...
class N213 : public QObject { // QWebSettings
    Q_OBJECT
public:
