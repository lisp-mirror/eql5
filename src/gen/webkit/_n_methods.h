...
class N265 : public QObject { // QWebDatabase
    Q_OBJECT
public:
...
class N266 : public QObject { // QWebElement
    Q_OBJECT
public:
...
class N267 : public QObject { // QWebElementCollection
    Q_OBJECT
public:
...
class N268 : public QObject { // QWebHistory
    Q_OBJECT
public:
...
class N269 : public QObject { // QWebHistoryItem
    Q_OBJECT
public:
...
class N270 : public QObject { // QWebHitTestResult
    Q_OBJECT
public:
...
class N271 : public QObject { // QWebSecurityOrigin
    Q_OBJECT
public:
...
class N272 : public QObject { // QWebSettings
    Q_OBJECT
public:
