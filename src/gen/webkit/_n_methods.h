...
class N234 : public QObject { // QWebDatabase
    Q_OBJECT
public:
...
class N237 : public QObject { // QWebHistory
    Q_OBJECT
public:
...
class N238 : public QObject { // QWebHistoryItem
    Q_OBJECT
public:
...
class N240 : public QObject { // QWebSecurityOrigin
    Q_OBJECT
public:
...
class N241 : public QObject { // QWebSettings
    Q_OBJECT
public:
