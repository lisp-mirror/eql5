...
class N97 : public QObject { // QImageEncoderSettings
    Q_OBJECT
public:
...
class N262 : public QObject { // QVideoEncoderSettings
    Q_OBJECT
public:
...
class N263 : public QObject { // QVideoFrame
    Q_OBJECT
public:
...
class N264 : public QObject { // QVideoSurfaceFormat
    Q_OBJECT
public:
