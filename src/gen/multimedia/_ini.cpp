...
void deleteNObject(int n, void* p, int gc) {
    switch(n) {
        ...
        case 198: if(gc) delete (QVideoEncoderSettings*)p; else delete (LVideoEncoderSettings*)p; break;
        case 199: if(gc) delete (QVideoFrame*)p; else delete (LVideoFrame*)p; break;
        case 200: if(gc) delete (QVideoSurfaceFormat*)p; else delete (LVideoSurfaceFormat*)p; break; }}
...
NumList* overrideFunctions(const QByteArray& name) {
    ...
    if(n != -1) {
        ...
        switch(n) {
            ...
            case 198: ids = &LVideoEncoderSettings::overrideIds; break;
            case 199: ids = &LVideoFrame::overrideIds; break;
            case 200: ids = &LVideoSurfaceFormat::overrideIds; break; }}
    return ids; }
