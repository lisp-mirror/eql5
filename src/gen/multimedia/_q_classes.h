...
public:
    ...
    QMediaObject* mediaObject() const { quint64 id = LObjects::override_id(unique, 161); void* fun = LObjects::overrideFun(id); QMediaObject* ret = 0; if(fun && (LObjects::calling != id)) { ret = (QMediaObject*)callOverrideFun(fun, 161, 0, id).value<void*>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QAudioRecorder::mediaObject(); } return ret; }
...
public:
    ...
    QMultimedia::AvailabilityStatus availability() const { quint64 id = LObjects::override_id(unique, 178); void* fun = LObjects::overrideFun(id); QMultimedia::AvailabilityStatus ret = (QMultimedia::AvailabilityStatus)0; if(fun && (LObjects::calling != id)) { ret = (QMultimedia::AvailabilityStatus)callOverrideFun(fun, 178, 0, id).toInt(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QCamera::availability(); } return ret; }
    bool bind(QObject* x1) { quint64 id = LObjects::override_id(unique, 179); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; ret = callOverrideFun(fun, 179, args, id).toBool(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QCamera::bind(x1); } return ret; }
    bool isAvailable() const { quint64 id = LObjects::override_id(unique, 180); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 180, 0, id).toBool(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QCamera::isAvailable(); } return ret; }
    QMediaService* service() const { quint64 id = LObjects::override_id(unique, 181); void* fun = LObjects::overrideFun(id); QMediaService* ret = 0; if(fun && (LObjects::calling != id)) { ret = (QMediaService*)callOverrideFun(fun, 181, 0, id).value<void*>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QCamera::service(); } return ret; }
    void unbind(QObject* x1) { quint64 id = LObjects::override_id(unique, 182); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 182, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QCamera::unbind(x1); }}
...
public:
    ...
    QMediaObject* mediaObject() const { quint64 id = LObjects::override_id(unique, 161); void* fun = LObjects::overrideFun(id); QMediaObject* ret = 0; if(fun && (LObjects::calling != id)) { ret = (QMediaObject*)callOverrideFun(fun, 161, 0, id).value<void*>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QCameraImageCapture::mediaObject(); } return ret; }
    bool setMediaObject(QMediaObject* x1) { quint64 id = LObjects::override_id(unique, 183); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; ret = callOverrideFun(fun, 183, args, id).toBool(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QCameraImageCapture::setMediaObject(x1); } return ret; }
...
public:
    ...
    QVariant inputMethodQuery(Qt::InputMethodQuery x1) const { quint64 id = LObjects::override_id(unique, 23); void* fun = LObjects::overrideFun(id); QVariant ret; if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; ret = callOverrideFun(fun, 23, args, id).value<QVariant>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QCameraViewfinder::inputMethodQuery(x1); } return ret; }
...
public:
    ...
    QRectF boundingRect() const { quint64 id = LObjects::override_id(unique, 260); void* fun = LObjects::overrideFun(id); QRectF ret; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 260, 0, id).value<QRectF>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QGraphicsVideoItem::boundingRect(); } return ret; }
    void paint(QPainter* x1, const QStyleOptionGraphicsItem* x2, QWidget* x3 = 0) { quint64 id = LObjects::override_id(unique, 231); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1, &x2, &x3 }; callOverrideFun(fun, 231, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QGraphicsVideoItem::paint(x1, x2, x3); }}
...
public:
    ...
    bool bind(QObject* x1) { quint64 id = LObjects::override_id(unique, 179); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; ret = callOverrideFun(fun, 179, args, id).toBool(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QMediaObject::bind(x1); } return ret; }
    bool isAvailable() const { quint64 id = LObjects::override_id(unique, 180); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 180, 0, id).toBool(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QMediaObject::isAvailable(); } return ret; }
    QMediaService* service() const { quint64 id = LObjects::override_id(unique, 181); void* fun = LObjects::overrideFun(id); QMediaService* ret = 0; if(fun && (LObjects::calling != id)) { ret = (QMediaService*)callOverrideFun(fun, 181, 0, id).value<void*>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QMediaObject::service(); } return ret; }
    void unbind(QObject* x1) { quint64 id = LObjects::override_id(unique, 182); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 182, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QMediaObject::unbind(x1); }}
...
public:
    ...
    bool bind(QObject* x1) { quint64 id = LObjects::override_id(unique, 179); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; ret = callOverrideFun(fun, 179, args, id).toBool(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QMediaPlayer::bind(x1); } return ret; }
    bool isAvailable() const { quint64 id = LObjects::override_id(unique, 180); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 180, 0, id).toBool(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QMediaPlayer::isAvailable(); } return ret; }
    QMediaService* service() const { quint64 id = LObjects::override_id(unique, 181); void* fun = LObjects::overrideFun(id); QMediaService* ret = 0; if(fun && (LObjects::calling != id)) { ret = (QMediaService*)callOverrideFun(fun, 181, 0, id).value<void*>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QMediaPlayer::service(); } return ret; }
    void unbind(QObject* x1) { quint64 id = LObjects::override_id(unique, 182); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 182, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QMediaPlayer::unbind(x1); }}
...
public:
    ...
    QMediaObject* mediaObject() const { quint64 id = LObjects::override_id(unique, 161); void* fun = LObjects::overrideFun(id); QMediaObject* ret = 0; if(fun && (LObjects::calling != id)) { ret = (QMediaObject*)callOverrideFun(fun, 161, 0, id).value<void*>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QMediaPlaylist::mediaObject(); } return ret; }
...
public:
    ...
    QMediaObject* mediaObject() const { quint64 id = LObjects::override_id(unique, 161); void* fun = LObjects::overrideFun(id); QMediaObject* ret = 0; if(fun && (LObjects::calling != id)) { ret = (QMediaObject*)callOverrideFun(fun, 161, 0, id).value<void*>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QMediaRecorder::mediaObject(); } return ret; }
...
public:
    ...
    bool bind(QObject* x1) { quint64 id = LObjects::override_id(unique, 179); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; ret = callOverrideFun(fun, 179, args, id).toBool(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QRadioTuner::bind(x1); } return ret; }
    bool isAvailable() const { quint64 id = LObjects::override_id(unique, 180); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 180, 0, id).toBool(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QRadioTuner::isAvailable(); } return ret; }
    QMediaService* service() const { quint64 id = LObjects::override_id(unique, 181); void* fun = LObjects::overrideFun(id); QMediaService* ret = 0; if(fun && (LObjects::calling != id)) { ret = (QMediaService*)callOverrideFun(fun, 181, 0, id).value<void*>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QRadioTuner::service(); } return ret; }
    void unbind(QObject* x1) { quint64 id = LObjects::override_id(unique, 182); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 182, args, id); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { QRadioTuner::unbind(x1); }}
...
public:
    ...
    QVariant inputMethodQuery(Qt::InputMethodQuery x1) const { quint64 id = LObjects::override_id(unique, 23); void* fun = LObjects::overrideFun(id); QVariant ret; if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; ret = callOverrideFun(fun, 23, args, id).value<QVariant>(); } if(!fun || LObjects::call_default || (LObjects::calling == id)) { ret = QVideoWidget::inputMethodQuery(x1); } return ret; }
...
public:
    ...
    Qt::AspectRatioMode aspectRatioMode() const { quint64 id = LObjects::override_id(unique, 420); void* fun = LObjects::overrideFun(id); Qt::AspectRatioMode ret = (Qt::AspectRatioMode)0; if(fun && (LObjects::calling != id)) { ret = (Qt::AspectRatioMode)callOverrideFun(fun, 420, 0, id).toInt(); } return ret; }
    int brightness() const { quint64 id = LObjects::override_id(unique, 421); void* fun = LObjects::overrideFun(id); int ret = 0; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 421, 0, id).toInt(); } return ret; }
    int contrast() const { quint64 id = LObjects::override_id(unique, 422); void* fun = LObjects::overrideFun(id); int ret = 0; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 422, 0, id).toInt(); } return ret; }
    int hue() const { quint64 id = LObjects::override_id(unique, 423); void* fun = LObjects::overrideFun(id); int ret = 0; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 423, 0, id).toInt(); } return ret; }
    bool isFullScreen() const { quint64 id = LObjects::override_id(unique, 424); void* fun = LObjects::overrideFun(id); bool ret = false; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 424, 0, id).toBool(); } return ret; }
    int saturation() const { quint64 id = LObjects::override_id(unique, 425); void* fun = LObjects::overrideFun(id); int ret = 0; if(fun && (LObjects::calling != id)) { ret = callOverrideFun(fun, 425, 0, id).toInt(); } return ret; }
    void setAspectRatioMode(Qt::AspectRatioMode x1) { quint64 id = LObjects::override_id(unique, 426); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 426, args, id); }}
    void setBrightness(int x1) { quint64 id = LObjects::override_id(unique, 427); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 427, args, id); }}
    void setContrast(int x1) { quint64 id = LObjects::override_id(unique, 428); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 428, args, id); }}
    void setFullScreen(bool x1) { quint64 id = LObjects::override_id(unique, 429); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 429, args, id); }}
    void setHue(int x1) { quint64 id = LObjects::override_id(unique, 430); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 430, args, id); }}
    void setSaturation(int x1) { quint64 id = LObjects::override_id(unique, 431); void* fun = LObjects::overrideFun(id); if(fun && (LObjects::calling != id)) { const void* args[] = { &x1 }; callOverrideFun(fun, 431, args, id); }}
    QWidget* videoWidget() { quint64 id = LObjects::override_id(unique, 432); void* fun = LObjects::overrideFun(id); QWidget* ret = 0; if(fun && (LObjects::calling != id)) { ret = (QWidget*)callOverrideFun(fun, 432, 0, id).value<void*>(); } return ret; }
