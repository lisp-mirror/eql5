...
(defun |toNumber| (object &rest arguments)
  (%qinvoke-method object nil "toNumber" arguments))
...
(defun |toQObject| (object &rest arguments)
  (%qinvoke-method object nil "toQObject" arguments))
...
(defun |toVariant| (object &rest arguments)
  (%qinvoke-method object nil "toVariant" arguments))
...
(defun |transformOriginChanged| (object &rest arguments)
  (%qinvoke-method object nil "transformOriginChanged" arguments))

(defun |transformOriginPoint| (object &rest arguments)
  (%qinvoke-method object (%auto-cast object) "transformOriginPoint" arguments))

(defun |transformOrigin| (object &rest arguments)
  (%qinvoke-method object nil "transformOrigin" arguments))
...
(defun |triggerUpdate| (object &rest arguments)
  (%qinvoke-method object nil "triggerUpdate" arguments))
...
(defun |trimComponentCache| (object &rest arguments)
  (%qinvoke-method object nil "trimComponentCache" arguments))
...
(defun |ungrabTouchPoints| (object &rest arguments)
  (%qinvoke-method object nil "ungrabTouchPoints" arguments))
...
(defun |updateBindOptions| (object &rest arguments)
  (%qinvoke-method object nil "updateBindOptions" arguments))
...
(defun |updateInputMethod| (object &rest arguments)
  (%qinvoke-method object nil "updateInputMethod" arguments))
...
(defun |updateRectGeometry.QSGGeometry| (&rest arguments)
  (%qinvoke-method "QSGGeometry" nil "updateRectGeometry" arguments))
...
(defun |updateState| (object &rest arguments)
  (%qinvoke-method object nil "updateState" arguments))

(defun |updateTexturedRectGeometry.QSGGeometry| (&rest arguments)
  (%qinvoke-method "QSGGeometry" nil "updateTexturedRectGeometry" arguments))

(defun |updateTexture| (object &rest arguments)
  (%qinvoke-method object nil "updateTexture" arguments))
...
(defun |vertexCount| (object &rest arguments)
  (%qinvoke-method object nil "vertexCount" arguments))

(defun |vertexDataPattern| (object &rest arguments)
  (%qinvoke-method object nil "vertexDataPattern" arguments))
...
(defun |verticalWrapMode| (object &rest arguments)
  (%qinvoke-method object nil "verticalWrapMode" arguments))
...
(defun |viewportRect| (object &rest arguments)
  (%qinvoke-method object nil "viewportRect" arguments))
...
(defun |visibleChildrenChanged| (object &rest arguments)
  (%qinvoke-method object nil "visibleChildrenChanged" arguments))
...
(defun |warnings| (object &rest arguments)
  (%qinvoke-method object nil "warnings" arguments))
...
(defun |wheelEvent| (object &rest arguments)
  (%qinvoke-method object nil "wheelEvent" arguments))
...
(defun |widthValid| (object &rest arguments)
  (%qinvoke-method object nil "widthValid" arguments))
...
(defun |windowChanged| (object &rest arguments)
  (%qinvoke-method object nil "windowChanged" arguments))
...
(defun |write.QQmlProperty| (&rest arguments)
  (%qinvoke-method "QQmlProperty" nil "write" arguments))
